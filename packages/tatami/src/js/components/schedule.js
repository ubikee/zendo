  ...
  render() {
    return (
      <div className="schedule">
        <List data={this.props.events} renderer={DateRenderer} groupBy={this.props.groupBy} groupRenderer={this.props.groupRenderer} onSelection={this.props.onSelection}/>
      </div>
    )
  }
}
