 ...
 * Confirm Dialog
 */
const ConfirmDialog = ({icon, title, message, onOK, canOK = true, onCancel, onClose, children, className, buttons}) => {
  ...
  return (
    <Panel icon={icon} title={title} className={`window dialog ${className}`} collapsed={false} collapsable={false} actions={actionz} >
